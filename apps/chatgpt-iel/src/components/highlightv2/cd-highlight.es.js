...
let CdHighlight = class extends i {
  constructor() {
    super(...arguments);
    this.color = "yellow";
    this.delay = 0;
  ...
  _scheduleVisibilityStabilizationCheck() {
  ...
  _sortQueueByDOMOrder() {
    const allElements = Array.from(document.querySelectorAll("cd-highlight"));
    CdHighlight._highlightQueue.sort((a2, b2) => {
      const indexA = allElements.indexOf(a2);
      const indexB = allElements.indexOf(b2);
  ...
  _tryStartAnimation() {
    ...
    if (!canStart) {
      canStart = true;
      for (let i2 = 0; i2 < myIndex; i2++) {
        const prevElement = CdHighlight._highlightQueue[i2];
  ...
  _onOtherAnimationComplete(event) {
    const completedElement = event.target;
  ...
  _startAnimation() {
    ...
    this._textContent = ((_a2 = this.textContent) == null ? void 0 : _a2.trim()) || "";
    const baseTime = 1e3;
    const additionalTime = Math.max(0, (this._textContent.length - 20) * 10);
    this._animationDuration = Math.min(baseTime + additionalTime, 6e3);
...
CdHighlight._highlightQueue = [];
CdHighlight._allElementsRegistered = false;
CdHighlight._visibilityStabilized = false;
CdHighlight.styles = i$3`
    :host {
...
__decorateClass([
  n2({ type: String })
], CdHighlight.prototype, "color", 2);
__decorateClass([
  n2({ type: Number })
], CdHighlight.prototype, "delay", 2);
__decorateClass([
  r()
], CdHighlight.prototype, "_isVisible", 2);
__decorateClass([
  r()
], CdHighlight.prototype, "_isAnimating", 2);
__decorateClass([
  r()
], CdHighlight.prototype, "_canAnimate", 2);
__decorateClass([
  r()
], CdHighlight.prototype, "_hasAnimated", 2);
CdHighlight = __decorateClass([
  t("cd-highlight")
], CdHighlight);
export {
  CdHighlight
