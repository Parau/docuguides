...
<div className="youtube-responsive-container">
  <LiteYouTubeEmbed
    id="w5LFEvEtqTQ"
    title="Como alfabetizar com o nome próprio | Atividade Profa | Nova Escola"
  />
</div>
...
<div className="youtube-responsive-container">
  <LiteYouTubeEmbed
    id="1DfFR0Tr0Uk"
    title="Alfabetização com o nome próprio – Parte 2 | Atividade Profa | Nova Escola"
  />
</div>
...
<div className="youtube-responsive-container">
  <LiteYouTubeEmbed
    id="MfiEJ_Y22Bc"
    title="A conquista do nome próprio"
  />
</div>
<br />
